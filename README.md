...
- ASP.NET- Платформа для создания web-приложения ;
- MVC - Шаблон программирования;
- C# - Язык программирования;
- API - Способ взаимодействия клиента с поставщиком;
- JOSN - Формат данных, предоставляемый поставщиком.
